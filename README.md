...
### Installation
To use hopscotch-map, just add the project to your include path. It is a **header-only** library.
...
To achieve this, these versions use a binary search tree for the overflown elements (see [implementation details](https://tessil.github.io/2016/08/29/hopscotch-hashing.html)) and thus need the elements to be `LessThanComparable`. An additional `Compare` template parameter is needed.
